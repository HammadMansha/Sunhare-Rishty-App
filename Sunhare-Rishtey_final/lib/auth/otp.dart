  ...
  final Color enteredColor;
   ...
   UnderlineDecoration({
    ...
    this.lineHeight: 2.0,
          ...
          obscureStyle: obscureStyle ?? ObscureStyle(),
          errorText: errorText ?? "",
          errorTextStyle: errorTextStyle ?? TextStyle(),
          hintText: hintText ?? "Enter Otp",
...
class BoxTightDecoration extends PinDecoration {
  ...
  BoxTightDecoration({
    ...
    required ObscureStyle obscureStyle,
...
class PinInputTextField extends StatefulWidget {
  ...
  PinInputTextField({
    ...
    this.onSubmit,
    this.decoration,
    //this.decoration = BoxLooseDecoration(hintText: "",errorText: "",errorTextStyle: TextStyle(),hintTextStyle:  TextStyle(),obscureStyle: ObscureStyle(),textStyle: TextStyle(),enteredColor: Colors.black,gapSpace: 1,gapSpaces: const [10.0],radius:  Radius.circular(8.0),solidColor: Colors.black,strokeColor: Colors.black,strokeWidth: 1),
...
class _PinPaint extends CustomPainter {
  ...
  _drawUnderLine(Canvas canvas, Size size) {
    ...
    /// we use a simple logic to calculate it.
    double mainHeight;
    if (decoration?.errorText != null && (decoration?.errorText.isNotEmpty ?? false)) {
      mainHeight = size.height - ((decoration?.errorTextStyle.fontSize??0) + 8.0);
    } else {
      mainHeight = size.height;
    }
    ...
    for (int i = 0; i < pinLength; i++) {
      if (i < text.length && dr.enteredColor != null) {
        ...
        underlinePaint.color = decoration?.errorTextStyle.color ?? Colors.black;
      } else {
    ...
    /// Determine whether display obscureText.
    bool obscureOn = decoration?.obscureStyle != null &&
        (decoration?.obscureStyle.isTextObscure ?? false);
    ...
    ValueChanged<String>? onChanged,
        ...
        super(
            ...
            builder: (FormFieldState<String> field) {
              //_PinInputTextFormFieldState state = field;
